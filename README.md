...
## Example phrases
```
Alexa, ask alexa randomcat skill …
Alexa, ask alexa randomcat skill …
Alexa, ask alexa randomcat skill …
```
...
If you configure the project with AWS credentials then you can build, test, package and deploy the project with a single command. You can check it out in the [AWS console](https://console.aws.amazon.com/lambda/home?region=us-east-1#/functions/alexa-randomcat-skill).
